	...
	$html = 
		"<html>
			...
			<p>
				&nbsp;</p>
			<p>
				CL&Aacute;USULA 18&ordf; -&nbsp; O valor do curso &eacute; <strong>R$ " . number_format($cursos_valor, 2) ." </strong>.</p>
			<p>
				&nbsp;</p>
			<p>
