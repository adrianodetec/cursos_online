...
{
	$query .= 'ORDER BY tb_matricula.data_pg DESC ';
}
if($_POST["length"] != -1)
{
...
foreach($result as $row)
{
	...
	if($statusPG == "PENDENTE" and $row["data_pg"] == '')
	{
		$exibeMensagem = "<strong><font color='red'>PENDENTE</font></strong>";
	}
	elseif($statusPG == "PENDENTE" and $row["data_pg"] != '')
	{
		$exibeMensagem = "<strong><font color='orange'>AGUARDANDO FINANCEIRO</font></strong>";
	}
	else{
