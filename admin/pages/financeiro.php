...
include "seguranca_financeiro.php";
			...
			<div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
						    <h2>
                                GRÁFICO VALOR TOTAL (PAGO/PENDENTE) POR MÊS DE PAGAMENTO
                            </h2>                            
                        </div>
						...
						<div class="container-fluid">
								...
								<div role="tabpanel" class="tab-pane fade in active" id="home"><!-- gráfico barra vertical --> 
									...
									<table align="left">
										<tr>										
										<td bgcolor="green"><font color="white"><strong>PAGAMENTO APROVADO</strong></font></td>
										</tr>
										<tr>										
										<td bgcolor="red"><font color="white"><strong>PAGAMENTO PENDENTE</strong></font></td>
										</tr>							
									</table>
